...
export class CComment {
  ...
  @ManyToOne(() => CComment, (cComment) => cComment.cComments, {
    onDelete: "CASCADE",
    onUpdate: "CASCADE",
  })
  ...
  @OneToMany(() => CComment, (cComment) => cComment.side)
  cComments: CComment[];

  @ManyToOne(() => CPost, (cPost) => cPost.cComments, {
    onDelete: "CASCADE",
    onUpdate: "CASCADE",
  })
  ...
  @ManyToOne(() => CUser, (cUser) => cUser.cComments, {
    onDelete: "CASCADE",
    onUpdate: "CASCADE",
  })
  ...
  @OneToMany(() => CCommentImage, (cCommentImage) => cCommentImage.comment)
